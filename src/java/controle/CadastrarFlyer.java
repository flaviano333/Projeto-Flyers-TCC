 ...
 * @author Flávio
 */
@WebServlet(name = "CadastrarFlyer", urlPatterns = {"/CadastrarFlyer"})
@MultipartConfig(
...
public class CadastrarFlyer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Inserir Flyer</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if (nome == null || nome.equals("")) {
                ...
                try {
                    ...
                    out.print("alert('Flyer inserido com sucesso!!');");
