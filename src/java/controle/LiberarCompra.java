 ...
 * @author Flávio
 */
@WebServlet(name = "LiberarCompra", urlPatterns = {"/LiberarCompra"})
public class LiberarCompra extends HttpServlet {
        ...
        try {
            ...
            if (id == null || id.equals("")) {
                ...
                try {
                    ...
                    out.print("alert('Compra terminada!!!');");
                    out.print("location.href='relatorio_vendas.jsp';");
                    out.print("</script>");
