 ...
 * @author 339202
 */
@WebServlet(name = "ExcluirMensagem", urlPatterns = {"/ExcluirMensagem"})
        ...
        try {
            ...
            if (id == null || id.equals("")) {
                ...
                try {
                    ...
                    out.print("alert('Mensagem excluída com sucesso!!');");
                    if(idDestinatario == 0){
