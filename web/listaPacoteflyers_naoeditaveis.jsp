...
<html>
    ...
    <body>
        ...
        <table id="TabelasFlyers">
            ...
            <tr>
                <td align="center"> <h3 style="position:absolute; transform: translateX(-50%);left:50%; top:34%;"> Pacote de flyers não editáveis </h3></td>
             ...
             <%                                            
                            try {
                                ...
                                for(Flyers f:lista){
                                    %>
                                    <% 
                                        if("Pacote pronto nao editavel".equals(f.getTipo())){
