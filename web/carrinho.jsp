        ...
        <div id="menu" class="menu effect">
            ...
            <table id="TabelaBodyPrincipal">
               <tr>
                            ...
                            <tr>
                                <td>
                                    <td style="background-color: white; border: 1px solid #b3b3b3; border-radius:35px; transition: background-color 0.3s; height:40px; " onmouseover="this.style.backgroundColor='#e6f2ff'" onmouseout="this.style.backgroundColor=' white'">
                                         <a style="display:block; font-size:14px;text-decoration: none; color:blue;" href="carrinho.jsp"> &NonBreakingSpace;&NonBreakingSpace;Meu carrinho &NonBreakingSpace;&NonBreakingSpace;</a>  
                                     </td>                                
                                     <td style="background-color: white; border: 1px solid #b3b3b3; border-radius:35px; transition: background-color 0.3s; height:40px; " onmouseover="this.style.backgroundColor='#e6f2ff'" onmouseout="this.style.backgroundColor=' white'">
                                         <a style="display:block; font-size:14px;text-decoration: none; color:blue;" href="carrinho_a_pagar.jsp"> &NonBreakingSpace;&NonBreakingSpace;Compras aguardando validação &NonBreakingSpace;&NonBreakingSpace;</a>  
                                     </td> 
                                 <td style="background-color: white; border: 1px solid #b3b3b3; border-radius:35px; transition: background-color 0.3s; height:40px; " onmouseover="this.style.backgroundColor='#e6f2ff'" onmouseout="this.style.backgroundColor=' white'">
                ...
                <tr>
                    <td >
                        <%@ include file="lista_carrinho_do_usuario.jsp" %>
                        <br>
                        <br> 
                    </td>
                </tr>
