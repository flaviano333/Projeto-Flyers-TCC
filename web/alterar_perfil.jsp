...
%>        
        ...
        <table id="FichaCadastro" width="360">                
            <tr><td>
                    ...
                    <form name="form_menu" action="alterar_perfil.do" method="post">
                        <input type="hidden" name="id" value="<%=p.getIdPerfil() %>">
                        <table>    
                        <tr>
                            <td align="center" bgcolor="#7FFFD4">Id</td><td align="center"><%=p.getIdPerfil() %></td>                     
                        </tr>                             
                        <tr>
                            <td align="center" bgcolor="#7FFFD4">Nome do perfil:</td><td><input type="text" name="nome" value="<%=p.getPerfil() %>"></td>                     
                        </tr>                          
                        <tr>
