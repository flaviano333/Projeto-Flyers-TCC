...
<html>
    ...
    <body>
        ...
        <table id="TabelasFlyers">
            ...
            <tr>
                <td align="center"> <h3 style="position:absolute; transform: translateX(-50%);left:50%; top:34%;"> Flyers editáveis </h3></td>
             ...
             <%                                            
                            try {
                                ...
                                for(Flyers f:lista){
                                    %>
                                    <% 
                                        if("Flyer pronto editavel".equals(f.getTipo())){
                                            ...
                                            <table id="TabelasTd">
                                                ...
                                                <tr>
                                                    ...
                                                    <form  action="adicionar_carrinho.do" method="post">
                                                        ...
                                                        <input type="submit" class="estilo-botao-verde" value="Comprar"/>
                                                    </form>     
                                                </td>                                        
                                                </tr>
                                                <tr>
